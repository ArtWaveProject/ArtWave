		...
		<div class="row">
			...
			<div class="row" style="padding: 30px; background: aliceblue; border-radius: 30px;">
				...
				<c:forEach var="vo" items="${list}" varStatus="i">
					<div class="col-sm-2"
						style="margin: 0px 0px ${i.index>=6?'15px':'0px'} 0px; padding-top: 15px; background: white; border-radius:${i.index==0?'15px 0px 0px 0px;':i.index==5?'0px 15px 0px 0px;':i.index==11?'0px 0px 15px 0px;':i.index==6?'0px 0px 0px 15px;':''}">
						<img src="${vo.poster}" style="border-radius: 15px;"> <a href="../music/musicDetail.do?mno=${vo.mno}"> <span>${vo.title}</span><br>
						</a>
					</div>
				</c:forEach>
				<div class="col-lg-8">
						...
						<table class="table listChart">
							<c:forEach var="mvo" items="${mList}" varStatus="i">
								<tr style="vertical-align: middle;">
									...
									<td width="5%" class="text-center"><c:if test="${mvo.titlecheck==1}">
				...
				<div id="carouselExampleIndicators" class="carousel slide col-lg-4" data-bs-ride="carousel">
					<h4 style="color: black">
						<a href="../music/alstoreList.do">Goods ></a>
					</h4>
					...
					<div class="carousel-inner" style="margin-top: 20px; border-radius: 20px;">
						<div class="carousel-item active">
							<a href="../music/alstoreDetail.do?ano=${aList[0].ano}"> <img src="${aList[0].aphoto}" class="d-block w-100" alt="...">
								<div class="carousel-caption">
									<span class="ellipsis-text">${aList[0].aname}</span>
								</div>
							</a>
						</div>
						<div class="carousel-item">
							<a href="../music/alstoreDetail.do?ano=${aList[1].ano}"> <img src="${aList[1].aphoto}" class="d-block w-100" alt="...">
								<div class="carousel-caption">
									<span class="ellipsis-text">${aList[1].aname}</span>
								</div>
							</a>
						</div>
						<div class="carousel-item">
							<a href="../music/alstoreDetail.do?ano=${aList[2].ano}"> <img src="${aList[2].aphoto}" class="d-block w-100" alt="...">
								<div class="carousel-caption">
									<span class="ellipsis-text">${aList[2].aname}</span>
								</div>
							</a>
						</div>
						<div class="carousel-item">
							<a href="../music/alstoreDetail.do?ano=${aList[3].ano}"> <img src="${aList[3].aphoto}" class="d-block w-100" alt="...">
								<div class="carousel-caption">
									<span class="ellipsis-text">${aList[3].aname}</span>
								</div>
							</a>
						</div>
					</div>
