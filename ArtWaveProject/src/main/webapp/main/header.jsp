					...
					<nav class="main-nav navbar">
						...
						<ul class="nav">
							...
							<li class="dropdown">
								...
								<ul class="dropmenu">
									<li class="submenu">
										<a href="../movie/movielist1.do">전체 영화</a>
									</li>
									<li class="submenu">
										<a href="#">예매 하기</a>
									</li>
							...
							<li class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" href="../music/musicHome.do">
									음악<span class="caret"></span>
								</a>
								<ul class="dropmenu">
									<li class="submenu">
										<a href="../music/musicList.do">인기차트</a>
									</li>
									<li class="submenu">
										<a href="../music/albumList.do">앨범목록</a>
									</li>
									<li class="submenu">
										<a href="../music/musicMvList.do">뮤비목록</a>
									</li>
									<li class="submenu">
										<a href="../music/alstoreList.do">스토어</a>
									</li>
								</ul>
							</li>
							<li class="dropdown">
								...
								<ul class="dropmenu">
									...
									<li class="submenu">
										<a href="../music/albumList.do">공지사항</a>
									</li>
									<li class="submenu">
										<a href="../replyboard/list.do">문의</a>
									</li>
								</ul>
							</li>
							<c:if test="${sessionScope.id!=null }">
								...
								<c:if test="${sessionScope.admin=='1' }">
									<li>
										<a href="../adminpage/adminpage_main.do" class="active">관리자페이지</a>
									</li>
								</c:if>
							</c:if>
						...
						<c:if test="${sessionScope.id!=null }">
							<ul class="nav">
								...
								<c:if test="${sessionScope.admin==1 }">
									<li>
										<a id="info">${sessionScope.nickname}(${sessionScope.admin=='1'?"관리자":""})님</a>
									</li>
								</c:if>
								<c:if test="${sessionScope.admin==0 }">
									<li>
										<a href="../mypage/mypage_main.do" id="info">${sessionScope.nickname}님</a>
									</li>
								</c:if>
								<li>
									<a id="info">
