...
<body>
	<div class="page-content"
		style="margin: 150px 0 0 305px; width: 1270px; text-align: center; background-color: white;">
		<h2 style="color: black; margin-top: -50px; margin-bottom: 40px;">새로나온
			책</h2>
		<div class="book-list">
			<c:forEach var="vo" items="${nList}">
				<div class="book-item">
					<div class="book-cover">
						<a href="../book/detail.do?bno=${vo.bno }"> <img height=100%;
							src="${vo.cover }" alt="">
						</a>
					</div>
					<div class="book-info">
