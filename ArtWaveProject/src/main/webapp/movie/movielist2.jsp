...
<body>
	...
	<div class="page-content2">
		...
		<div class="btn2-category-container">
			<a id="listbtn" href="../movie/movielist1.do" class="btn2-category">박스오피스</a> <a id="listbtnactive" href="../movie/movielist2.do"
				class="btn2-category">독립＆예술영화</a>
		</div>
							...
							<div class="item">
								<div class="thumb">
									...
									<div class="hover-effect">
										<h6 id="hetext">
											<a href="../movie/moviedetail_before.do?mno=${vo.mno }"><i class="fa fa-eye"></i>&nbsp; 상세보기 &nbsp;</a>
										</h6>
									</div>
								</div>
			...
			<nav>
				<ul class="pagination">
					...
					<c:forEach var="i" begin="${startPage}" end="${endPage}">
						<li class="page-item ${i == curpage ? 'active' : ''}"><a class="page-link" href="../movie/movielist2.do?page=${i}">${i}</a></li>
					</c:forEach>
